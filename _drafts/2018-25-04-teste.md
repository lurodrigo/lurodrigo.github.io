---
title:  "Sobre uma pequena conexão entre anagramas e álgebra"
...
Do ponto de vista técnico, há problemas a serem considerados para uma implementação
...
*Exemplo 3:* Podemos generalizar um pouco o exemplo anterior e pensar em tabelas.
...
somar os multiconjuntos, dá no mesmo. Quando apenas a estrutura é preservada, temos um homomorfismo.
Homomorfismos são a regra geral e isomorfismos são um caso especial: nem
sempre é possível ou desejável preservar informação.
...
Na verdade, não apenas preservamos como
